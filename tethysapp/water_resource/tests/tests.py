    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.water_resource"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.water_resource.tests.tests"

        To run tests in the WaterResourceTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.water_resource.tests.tests.WaterResourceTestCase"

        To run only the test_if_tethys_platform_is_great function in the WaterResourceTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.water_resource.tests.tests.WaterResourceTestCase.test_if_tethys_platform_is_great"
...
class WaterResourceTestCase(TethysTestCase):
    """
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(WaterResource)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(WaterResource)
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/water-resource/')  # The final '/' is essential for all pages/controllers
